...
import {
  ShoppingCart, LayoutDashboard, PlusCircle, Star,
  BarChart2, Lightbulb, Leaf, LogOut, User,
} from "lucide-react";
    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href={user ? "/dashboard" : "/"} className="flex items-center gap-2 font-bold text-green-700 text-lg flex-shrink-0">
